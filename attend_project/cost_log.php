        ...
        <div class="row">
            <div class="col-6 order-1">
                ...
                ?>
                    <div class="row">
                    <?php
                        $data = $DB->query("SELECT cost_result.id, item_id,cost_date,children_id,cost_name,item_count from cost_result left outer join cost_info on item_id = cost_id where children_id = '".$children_id['children_id']."' AND cost_date like '%".$date_data."%'");
                        $item = $data->fetch();
                    ?>
                         <div class=col-2>
                            <p><?php print($i);?>日</p>
                        ...
                        <div class=col-6>
                            <p>品名</p>
                            <?php if(isset($item['cost_date'])){print($item['cost_name']."<br>");}else{print("");} ?>
                        </div>
                        <div class=col-2>
                            <p>個数</p>
                            <?php if(isset($item['cost_date'])){print($item['item_count']."<br>");}else{print("0");} ?>
                        </div>
                        <div class=col-2>
